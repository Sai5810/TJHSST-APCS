...
class Sentence {
   private final String mySentence;
   private final int myNumWords;

   //Precondition:  str is not empty.
   //               Words in str separated by exactly one blank.
   public Sentence(String str) {
      mySentence = str;
      myNumWords = str.split("\\s+").length;
   }
   ...
   public boolean isPalindrome() {
      String t = removePunctuation(lowerCase(removeBlanks(mySentence)));
      return isPalindrome(t, 0, t.length() - 1);
   }
